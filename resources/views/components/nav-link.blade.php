...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-cyan-500 dark:border-cyan-400 text-sm font-medium leading-5 text-slate-900 dark:text-white focus:outline-none focus:border-cyan-700 transition duration-150 ease-in-out'
