    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex flex-col justify-between gap-4 rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:p-8">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500 max-w-xl">Organize, track, and advance your daily deliverables with real-time operational oversight.</p>
            </div>
        ...
        <div class="mt-8 mb-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
                <h2 class="text-xl font-bold tracking-tight text-slate-900">Work Queue</h2>
                <p class="text-xs text-slate-500">Add tasks and manage your operational flow.</p>
            </div>
