...
<html lang="en" data-user-pref="{{ auth()->check() ? (auth()->user()->dark_mode ? 'true' : 'false') : 'null' }}" class="h-full bg-slate-100 dark:bg-slate-900">
    ...
    <body class="admin-shell flex min-h-full max-w-full flex-col overflow-x-hidden font-sans text-slate-900 dark:text-slate-100 antialiased selection:bg-teal-700 selection:text-white" x-data="{ sidebarOpen: false }">
        <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-lg focus:bg-teal-700 focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-400">
        ...
        <header class="sticky top-0 z-40 border-b border-slate-800 bg-slate-950 text-white">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 lg:px-8">
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ url('/') }}" class="flex items-center gap-2.5 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400">
                ...
                <div class="flex items-center gap-3 text-sm">
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex h-7 w-7 items-center justify-center rounded-full bg-teal-900 text-xs font-bold text-teal-200 ring-1 ring-teal-500/30">
        ...
        <div class="mx-auto flex w-full max-w-7xl flex-1 gap-6 px-4 py-8 sm:px-6 lg:px-8">
            ...
            <aside class="hidden w-64 shrink-0 lg:block">
                <div class="sticky top-24 space-y-6">
                    <div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 p-5 shadow-sm">
                        <div class="mb-4 flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-4">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-950/60 text-sm font-bold text-teal-800 dark:text-teal-300">
                                {{ strtoupper(substr(auth()->user()->name, 0, 2)) }}
                            </div>
            ...
            <!-- Main Content Area -->
            <main id="main-content" class="min-w-0 max-w-full flex-1" tabindex="-1">
                @if (session('status'))
                    <div class="mb-6 flex items-center gap-3 rounded-xl border border-teal-200 dark:border-teal-800 bg-teal-50 dark:bg-teal-950/40 px-4 py-3 text-sm text-teal-800 dark:text-teal-300 shadow-sm" role="status" aria-live="polite">
                        <svg class="h-5 w-5 shrink-0 text-teal-600 dark:text-teal-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                @if (session('success'))
                    <div class="mb-6 flex items-center gap-3 rounded-xl border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/40 px-4 py-3 text-sm text-emerald-800 dark:text-emerald-300 shadow-sm" role="status" aria-live="polite">
                ...
                @if (session('error'))
                    <div class="mb-6 flex items-center gap-3 rounded-xl border border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-950/40 px-4 py-3 text-sm text-rose-800 dark:text-rose-300 shadow-sm" role="alert" aria-live="assertive">
        ...
        >
            <div>
                <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
                    <div class="flex items-center gap-2.5">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-teal-700 text-white font-bold text-xs">
                            ET
                        </div>
