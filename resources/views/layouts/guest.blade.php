    ...
    <body class="guest-shell flex min-h-full max-w-full flex-col justify-center overflow-x-hidden py-12 sm:px-6 lg:px-8 font-sans text-slate-900 dark:text-slate-100 antialiased selection:bg-teal-700 selection:text-white">
        <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
            <div class="flex items-center justify-center gap-3">
                <a href="{{ url('/') }}" class="inline-flex min-h-[44px] items-center gap-3 group focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 rounded-xl p-1" aria-label="Enterprise Tasks Home">
            ...
            <p class="mt-1 text-center text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400 font-semibold">
        ...
        <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0 space-y-3">
            @if (session('status'))
                <div class="flex items-start gap-3 rounded-xl border border-teal-300 dark:border-teal-800 bg-teal-50 dark:bg-teal-950/40 px-4 py-3 text-sm text-teal-800 dark:text-teal-300 shadow-xs" role="status" aria-live="polite">
                    <svg class="mt-0.5 h-5 w-5 shrink-0 text-teal-700 dark:text-teal-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            @endif
            @if (session('success'))
                <div class="flex items-start gap-3 rounded-xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/40 px-4 py-3 text-sm text-emerald-800 dark:text-emerald-300 shadow-xs" role="status" aria-live="polite">
                    <svg class="mt-0.5 h-5 w-5 shrink-0 text-emerald-700 dark:text-emerald-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            @endif
            @if (session('error'))
                <div class="flex items-start gap-3 rounded-xl border border-rose-300 dark:border-rose-800 bg-rose-50 dark:bg-rose-950/40 px-4 py-3 text-sm text-rose-800 dark:text-rose-300 shadow-xs" role="alert">
                    <svg class="mt-0.5 h-5 w-5 shrink-0 text-rose-700 dark:text-rose-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
            <div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-8 shadow-xs">
