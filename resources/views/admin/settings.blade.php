    ...
    <div class="space-y-6">
        <div class="flex flex-col justify-between gap-6 border-b border-slate-300 pb-8 dark:border-slate-700 sm:flex-row sm:items-end">
            <div>
                ...
                <p class="mt-2 text-base leading-relaxed text-slate-700 dark:text-slate-300">Update site identity, contact, and availability settings.</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm space-y-4">
                <div class="border-b border-slate-100 dark:border-slate-700 pb-3">
                    ...
                    <p class="mt-2 text-base leading-relaxed text-slate-700 dark:text-slate-300">Site name and admin contact email.</p>
                </div>

                <div class="grid gap-6 md:grid-cols-2">
                    <div class="space-y-1.5">
                        <label class="block text-sm font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300">Site Name <span class="text-rose-500">*</span></label>
                        <input
                            type="text"
                            name="site_name"
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-sm font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300">Admin Contact Email <span class="text-rose-500">*</span></label>
                        <input
                            type="email"
                            name="admin_email"
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm space-y-4">
                <div class="border-b border-slate-100 dark:border-slate-700 pb-3">
                    ...
                    <p class="mt-2 text-base leading-relaxed text-slate-700 dark:text-slate-300">Maintenance mode and user registration limits.</p>
                </div>

                <div class="grid gap-6 md:grid-cols-2">
                    <div class="space-y-1.5">
                        <label class="block text-sm font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300">Maintenance Mode</label>
                        <select
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-sm font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300">Max System Users Limit</label>
                        <input
                            type="number"
                            name="max_users"
            ...
            <div class="flex justify-end gap-3">
                <button
                    type="submit"
                    class="inline-flex min-h-[44px] min-w-[44px] items-center justify-center gap-2 rounded-xl bg-teal-700 hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-500 px-5 py-3 text-base font-semibold text-white shadow-sm transition focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                >
                    Save settings
                </button>
            </div>
