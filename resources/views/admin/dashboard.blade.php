...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col justify-between gap-6 border-b border-slate-300 pb-8 dark:border-slate-700 sm:flex-row sm:items-end">
            <div>
                <p class="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-teal-700 dark:text-teal-300">Administration</p>
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    ...
                    <span class="text-xs text-slate-400 dark:text-slate-500">accounts</span>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    <span class="text-3xl font-bold tracking-tight text-cyan-700 dark:text-cyan-400">{{ $stats['total_tasks'] ?? 0 }}</span>
                    <span class="text-xs text-cyan-700 dark:text-cyan-500">tasks</span>
                </div>
            </div>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <!-- Quick Action Cards -->
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-6">
