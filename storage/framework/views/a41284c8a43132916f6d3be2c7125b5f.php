<div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm">
    <div class="mb-4 flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
        ...
        <span class="text-xs text-slate-400 dark:text-slate-500">Total: <?php echo e($tasks->total()); ?></span>
    </div>
                        ...
                        <tr class="group transition hover:bg-slate-50/80 dark:hover:bg-slate-700/50">
                            ...
                            <td class="py-3.5 pr-4 align-top">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->description): ?>
                                    <div class="mt-0.5 text-xs text-slate-500 dark:text-slate-400 line-clamp-1"><?php echo e($task->description); ?></div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['type' => 'status','value' => $task->status]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'status','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->status)]); ?>
...
<?php endif; ?>
                            ...
                            <td class="py-3.5 pl-4 align-top text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button
                                        type="button"
                                        wire:click="$dispatch('open-edit-task-modal', { id: <?php echo e($task->id); ?> })"
                                        ...
                                        aria-label="Edit task <?php echo e($task->title); ?>"
                                    >
...
<?php /**PATH D:\Projects\task-enterprise-api\resources\views\livewire\task-list.blade.php ENDPATH**/ ?>