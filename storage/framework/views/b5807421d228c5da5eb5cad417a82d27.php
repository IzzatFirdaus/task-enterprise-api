<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-user-pref="<?php echo e(auth()->check() ? (auth()->user()->dark_mode ? 'true' : 'false') : 'null'); ?>" class="h-full bg-slate-100 dark:bg-slate-900">
    <?php
        $pageTitles = [
            'dashboard' => 'Dashboard',
        ...
        <header class="sticky top-0 z-40 border-b border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 lg:px-8">
                <div class="flex items-center gap-6">
                    <a href="<?php echo e(url('/')); ?>" class="group flex items-center gap-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 rounded-lg" aria-label="Enterprise Tasks Home">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3154912642-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3154912642-1', $__key);
...
</html><?php /**PATH D:\Projects\task-enterprise-api\resources\views\components\layouts\app.blade.php ENDPATH**/ ?>