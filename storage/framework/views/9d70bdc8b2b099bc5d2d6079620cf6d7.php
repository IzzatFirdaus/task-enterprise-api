<!DOCTYPE html>
<html lang="en" data-user-pref="<?php echo e(auth()->check() ? (auth()->user()->dark_mode ? 'true' : 'false') : 'null'); ?>" class="h-full bg-slate-100 dark:bg-slate-900">
    <?php
        $pageTitles = [
        ...
        <header class="sticky top-0 z-40 border-b border-slate-800 bg-slate-950 text-white">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 lg:px-8">
                <div class="flex items-center gap-4">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2.5 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">
                ...
                <div class="flex items-center gap-3 text-sm">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'moderator'])): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="hidden sm:inline-flex items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-800/80 px-3 py-1.5 text-xs font-semibold text-slate-200 transition hover:border-slate-600 hover:bg-slate-700 hover:text-white">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2073116046-0', $__key);
...
?>
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="hidden md:inline text-xs font-medium text-slate-300"><?php echo e(auth()->user()->name); ?></span>
                    </div>
                    ...
                    <div class="rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5 shadow-sm">
                        <div class="mb-4 flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-4">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="truncate text-sm font-semibold text-slate-900 dark:text-slate-100"><?php echo e(auth()->user()->name); ?></div>
                                <div class="flex items-center gap-1 mt-0.5">
                                    <?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['type' => 'role','value' => auth()->user()->isSuperAdmin() ? 'super_admin' : (auth()->user()->isAdmin() ? 'admin' : 'moderator'),'size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'role','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()->isSuperAdmin() ? 'super_admin' : (auth()->user()->isAdmin() ? 'admin' : 'moderator')),'size' => 'sm']); ?>
...
<?php endif; ?>
                        ...
                        <nav class="space-y-1" aria-label="Admin sidebar navigation">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-slate-900 dark:bg-slate-700 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <svg class="h-4 w-4 <?php echo e(request()->routeIs('admin.dashboard') ? 'text-cyan-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canModerate()): ?>
                                <a href="<?php echo e(route('admin.tasks.index')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition <?php echo e(request()->routeIs('admin.tasks.*') ? 'bg-slate-900 dark:bg-slate-700 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <svg class="h-4 w-4 <?php echo e(request()->routeIs('admin.tasks.*') ? 'text-cyan-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-slate-900 dark:bg-slate-700 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <svg class="h-4 w-4 <?php echo e(request()->routeIs('admin.users.*') ? 'text-cyan-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isSuperAdmin()): ?>
                                <a href="<?php echo e(route('admin.settings.index')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-slate-900 dark:bg-slate-700 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <svg class="h-4 w-4 <?php echo e(request()->routeIs('admin.settings.*') ? 'text-cyan-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                ...
                                <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'bg-slate-900 dark:bg-slate-700 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-white'); ?>">
                                    <svg class="h-4 w-4 <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'text-cyan-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'); ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:text-cyan-800 dark:hover:text-cyan-300 transition">
        ...
        >
            <div>
                ...
                <nav class="mt-4 space-y-1.5" aria-label="Mobile admin navigation">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-slate-900 dark:bg-slate-800 text-white' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'); ?>">
                            Dashboard
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canModerate()): ?>
                        <a href="<?php echo e(route('admin.tasks.index')); ?>" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('admin.tasks.*') ? 'bg-slate-900 dark:bg-slate-800 text-white' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'); ?>">
                            Task Moderation
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('admin.users.*') ? 'bg-slate-900 dark:bg-slate-800 text-white' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'); ?>">
                            User Management
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isSuperAdmin()): ?>
                        <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-slate-900 dark:bg-slate-800 text-white' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'); ?>">
                            System Settings
                        </a>
                        <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'bg-slate-900 dark:bg-slate-800 text-white' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'); ?>">
                            Audit Logs
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </nav>
            ...
            <div class="border-t border-slate-100 dark:border-slate-800 pt-4">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 rounded-lg bg-slate-100 dark:bg-slate-800 px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700">
...
<?php /**PATH D:\Projects\task-enterprise-api\resources\views\layouts\admin.blade.php ENDPATH**/ ?>