    ...
    <div class="space-y-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5 shadow-xs transition hover:border-slate-300 dark:hover:border-slate-700 hover:shadow-md">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    <span class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white"><?php echo e($stats['total_users'] ?? 0); ?></span>
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5 shadow-xs transition hover:border-slate-300 dark:hover:border-slate-700 hover:shadow-md">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    <span class="text-3xl font-bold tracking-tight text-cyan-800 dark:text-cyan-400"><?php echo e($stats['total_tasks'] ?? 0); ?></span>
            ...
            <div class="rounded-2xl border border-rose-200/80 dark:border-rose-900/60 bg-white dark:bg-slate-800 p-5 shadow-xs transition hover:border-rose-300 dark:hover:border-rose-700 hover:shadow-md">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    <span class="text-3xl font-bold tracking-tight text-rose-700 dark:text-rose-400"><?php echo e($stats['suspended_users'] ?? 0); ?></span>
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-5 shadow-xs transition hover:border-slate-300 dark:hover:border-slate-700 hover:shadow-md">
                ...
                <div class="mt-3 flex items-baseline gap-2">
                    <span class="text-3xl font-bold tracking-tight text-purple-800 dark:text-purple-400"><?php echo e($stats['recent_activity'] ?? 0); ?></span>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm lg:col-span-2">
                <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-4">
                    ...
                    <span class="text-xs text-slate-400 dark:text-slate-500">Total: <?php echo e($stats['total_tasks'] ?? 0); ?></span>
                </div>
                <div class="mt-5 space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stats['tasks_by_status'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        <div>
                            <div class="mb-1.5 flex items-center justify-between text-xs font-medium text-slate-700 dark:text-slate-300">
                                <div class="flex items-center gap-2">
                                    <span class="h-2 w-2 rounded-full <?php echo e($color); ?>"></span>
                                    <span class="capitalize"><?php echo e(str_replace('_', ' ', $status)); ?></span>
                                </div>
                                <span class="text-slate-500 dark:text-slate-400 font-semibold"><?php echo e($count); ?> (<?php echo e(number_format($statusWidth, 0)); ?>%)</span>
                            </div>
                            <div class="h-2.5 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700 ring-1 ring-slate-200/60 dark:ring-slate-600 ring-inset">
                                <div
                                    class="h-full rounded-full <?php echo e($color); ?> transition-all duration-500"
                                    style="<?php echo \Illuminate\Support\Arr::toCssStyles(['width' => $statusWidth . '%']) ?>"
                                ></div>
                            </div>
                        </div>
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm">
                ...
                <div class="mt-4 space-y-2.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="group flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-700 p-3.5 text-xs font-semibold text-slate-800 dark:text-slate-200 transition hover:border-cyan-600 dark:hover:border-cyan-500 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/40 hover:text-cyan-800 dark:hover:text-cyan-300">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canModerate()): ?>
                        <a href="<?php echo e(route('admin.tasks.index')); ?>" class="group flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-700 p-3.5 text-xs font-semibold text-slate-800 dark:text-slate-200 transition hover:border-cyan-600 dark:hover:border-cyan-500 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/40 hover:text-cyan-800 dark:hover:text-cyan-300">
                            <span class="flex items-center gap-2.5">
                                <svg class="h-4 w-4 text-slate-400 group-hover:text-cyan-700 dark:group-hover:text-cyan-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isSuperAdmin()): ?>
                        <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="group flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-700 p-3.5 text-xs font-semibold text-slate-800 dark:text-slate-200 transition hover:border-cyan-600 dark:hover:border-cyan-500 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/40 hover:text-cyan-800 dark:hover:text-cyan-300">
                            <span class="flex items-center gap-2.5">
                                <svg class="h-4 w-4 text-slate-400 group-hover:text-cyan-700 dark:group-hover:text-cyan-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        ...
                        <a href="<?php echo e(route('admin.settings.index')); ?>" class="group flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-700 p-3.5 text-xs font-semibold text-slate-800 dark:text-slate-200 transition hover:border-cyan-600 dark:hover:border-cyan-500 hover:bg-cyan-50/50 dark:hover:bg-cyan-950/40 hover:text-cyan-800 dark:hover:text-cyan-300">
                            <span class="flex items-center gap-2.5">
                                <svg class="h-4 w-4 text-slate-400 group-hover:text-cyan-700 dark:group-hover:text-cyan-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div class="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800 p-6 shadow-sm">
            <div class="mb-4 flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isSuperAdmin()): ?>
                    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="text-xs font-semibold text-cyan-700 dark:text-cyan-400 hover:text-cyan-800 dark:hover:text-cyan-300">
                    ...
                    <div class="flex items-center justify-between py-3.5">
                        <div class="flex items-center gap-3">
                            <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold">
                                <?php echo e(strtoupper(substr($activity->action, 0, 2))); ?>

                            </div>
                            <div>
                                <div class="text-sm font-semibold text-slate-900 dark:text-slate-100"><?php echo e(ucfirst(str_replace('_', ' ', $activity->action))); ?></div>
                                <div class="text-xs text-slate-500 dark:text-slate-400">
                                    <span class="font-medium text-slate-700 dark:text-slate-300"><?php echo e($activity->admin?->name ?? 'System Admin'); ?></span> · <?php echo e($activity->model_type ?? 'Entity'); ?> #<?php echo e($activity->model_id ?? '-'); ?>

                                </div>
                            </div>
                        </div>
                        <div class="text-xs text-slate-400 dark:text-slate-500">
                            <?php echo e($activity->created_at?->diffForHumans() ?? 'recently'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\task-enterprise-api\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>